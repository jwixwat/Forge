...
| INV-OPS-SEN-006 | fixture reports | `fixture_set_id`, `status`, `report_ts_utc` | `required_fixture_sets` | Latest report for each required fixture set must be `pass`. | v0.5 | declared |
