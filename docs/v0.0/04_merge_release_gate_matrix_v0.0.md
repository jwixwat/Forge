...
| G-MRG-V06-RES | merge | declared | v0.6 | residual recomputation from `primitive_inputs + provenance` equals logged residuals; derived-only recompute is invalid | block merge at v0.6 |
...
| G-REL-V08-SEN | release | declared | v0.8 | sentinel fixture suite pass in CI and runtime self-test | block release at v0.8 |
